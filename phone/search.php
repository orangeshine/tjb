...
<section class="main clearfix content_container">
  <?php if (have_posts()) : while (have_posts()) : the_post(); ?>
    ...
    <div class="search_text">
      ...
      <a href="http://www.juliedu.com/wp-content/themes/phone/baoming.html" target="_blank"><p>如果还没有发现满意的团建方案，欢迎给我们留言，</br>专业的团建顾问将会在2小时之内联系您，</br>提交满足您团队建设需求的方案</p><span>点击留言</a>
    </div>
    <?php endif; ?>
